...
public enum CapsStackText {
    public enum Key: String, CaseIterable, Sendable {
        ...
        case pendingBriefs = "Pending briefs"
        case pendingBriefsDescription = "Review pending briefs by cause. Only preserved timeout artifacts can be retried in bulk."
        case pendingBriefCount = "%lld pending briefs"
        case pendingCauseTimeout = "Timeout"
        case pendingCauseAuthentication = "Authentication"
        case pendingCauseUsageLimit = "Usage limit"
        case pendingCauseOther = "Other failure"
        case pendingCauseUnknown = "No diagnostic"
        case pendingArtifactUnavailable = "Artifact unavailable"
        case pendingRetryable = "Retryable"
        case reviewPendingBriefs = "Review pending briefs"
        case retryEligiblePending = "Retry %lld eligible briefs"
        case retryEligiblePendingConfirmation = "Retry only %lld timeout briefs?"
        case retryEligiblePendingMessage = "Authentication, usage-limit, and undiagnosed failures will be left unchanged. Preserved artifacts are processed one at a time."
        case retryNoEligiblePending = "No pending briefs are safe to retry automatically."
        case pendingRetryInProgress = "Retrying pending briefs…"
        case pendingRetryProgress = "%lld of %lld completed"
        case pendingRetryFinishedWithFailures = "%lld of %lld retries failed; failed artifacts were kept."
        case stopRetrying = "Stop retrying"
        ...
        case highlights = "What matters now"
        case sessionDetails = "Session details"
        case projectLevel = "Project-wide"
        case highlightNextAction = "Next action"
        case highlightWaiting = "Waiting"
        case highlightBlocker = "Problem"
        case highlightDecision = "Decision"
        case highlightDiscovery = "Discovery"
        case highlightVerification = "Verified"
        case highlightRisk = "Risk"
        case highlightChange = "Change"
        ...
        case eventPostingPermissionRequired = "Mac control permission required"
        case inputMonitoringPermissionMessage = "Input Monitoring permission is required. Allow CapsStack in System Settings > Privacy & Security > Input Monitoring."
        ...
        case eventPostingPermissionMessage = "Permission to control the Mac is required. Allow CapsStack in System Settings > Privacy & Security > Accessibility."
        case capsLockMonitoringFailed = "Could not start monitoring Caps Lock. Check CapsStack's keyboard and Mac control permissions."
